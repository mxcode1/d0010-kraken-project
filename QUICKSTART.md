...
# 2. Quick launch (auto-activates venv, starts server)
./run_demo_server.sh
```
...
**Open in Chrome Incognito:** http://127.0.0.1:8001/admin/
...
> ⚠️ **Browser showing errors?** Use Incognito/Private mode to bypass HSTS caching.
...
- **Import Data:** Use Testing Dashboard to load sample files
- **Browse Data:** Explore admin interface at `/admin/meter_readings/`
- **Production Setup:** See `documentation/DEPLOYMENT_GUIDE.md`
- **Dual Database:** Set `USE_POSTGRESQL=1` for PostgreSQL
